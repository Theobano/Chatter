            ...
            <Link to={`/blog/${article.id}`}>
                ...
                <div className="feed-article-footer">
                    <div className="feed-article-comments">
                        <CommentsIcon /><span>{article.comments} comments</span>
                    </div>
                    <div className="feed-article-likes">
                        <FavoriteIcon /><span>{article.likes} likes</span>
                    </div>
                    <div className="feed-article-views">
                        <AnalyticsIcon /><span>{article.views} views</span>
                        </div>
                </div>
            </Link>
