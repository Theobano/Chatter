...
export function Home() {
    return <HomeContainer>
        ...
        <header>
            <div className="overlay">
                <div>
                    ...
                    <p>
                        Unleash the Power of Words, Connext with Like-minded Readers and Writers
                    </p>
                    <Link to="/auth/register" className="styled-button">Get started</Link>
                </div>
            </div>
        </header>
        <main>
            <section className="section about" id="about">
                <div className="about-chatter">
                    ...
                    <div className="about-chatter-image">
                        <img src={AboutChatterImage} alt="About Chatter" />
                    </div>
            ...
            <section className="section join-chatter">
                <div>
                    <img src={AdebobolaMuhydeenImage} alt="Adebobola Muhydeen" />
                </div>
                <div>
                    <div>
                        <p>
                    ...
                    <Link to="/auth/register" className="styled-button">Join chatter</Link>
                </div>
            </section>
            <section className="section get-started">
                <div>
                    <div>
                        <img src={GetStartedImage1} alt="human" />
                        <img src={GetStartedImage2} alt="human" />
                    </div>
                    <div>
                        <img src={GetStartedImage3} alt="human" />
                    </div>
                </div>
                <div>
        ...
        <footer className="footer">
            <div>
                <Link to="/" className="logo">Chatter</Link>
            </div>
            <div>
                <h3>Explore</h3>
                <p>Community</p>
